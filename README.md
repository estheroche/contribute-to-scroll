...
This repository guides developers wanting to contribute to [Scroll](https://docs.scroll.io/en/getting-started/overview/). You can start contributing today, if you need ideas on getting started check out the [issues](https://github.com/scroll-tech/contribute/issues) tab.
